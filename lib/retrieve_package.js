...
let existsAsync = fs.exists || path.exists;
...
let install = fileReaderPromise.then(function(packageList) {
    ...
    packageList.forEach(function(r){
        ...
        existsAsync(dst,function(found) {
          if (found && !update_binary) {
              ...
              log.info('Run mason-js update to reinstall or mason-js build-from-source to recompile');
